<?php
     ...
     if($_POST)
    {
        ...
        if(!preg_match("/^[a-zA-Z]*$/", $edit_district)) 
        {
         $error_msg['edit_district2'] = "Only letters allowed";
        }
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p> 
                                <?php
                                    if(isset($error_msg['edit_district2'])) 
                                        echo "<div class='error'>" . $error_msg['edit_district2']. "</div>";
                                ?> 
                                </p>
                            </div>
                        </div>
